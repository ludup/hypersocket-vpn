...
public enum HTMLApplicationResourcePermission implements PermissionType {
	 ...
	 */
	private final static String name = "hTMLApplication";
	
	private PermissionType[] implies;
	
	private HTMLApplicationResourcePermission(final String val, PermissionType... implies) {
		this.val = name + "." + val;
